...
class sitterlisting{
    ...
    static public function filterListing($filter, $con) {
        ...
        $sql = "select sp_id, username, CONCAT(fname, ' ', lname) as 'fullname', sp_description, 
        TIME_FORMAT(sp_availablefrom, '$timeformat') as sp_availablefrom, TIME_FORMAT(sp_availableto, '$timeformat') as sp_availableto, sp_sun, sp_mon, sp_tues, sp_wed, sp_thurs, sp_fri, sp_sat, contact, zipcode, img
        from users, sitterprofiles
        where username = sp_username
